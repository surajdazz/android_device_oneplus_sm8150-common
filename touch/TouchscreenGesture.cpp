...
const std::map<int32_t, TouchscreenGesture::GestureInfo> TouchscreenGesture::kGestureInfoMap = {
    ...
    {4, {66, "One finger up swipe", "/proc/touchpanel/up_swipe_enable"}},
    {5, {65, "One finger right swipe", "/proc/touchpanel/right_swipe_enable"}},
    {6, {64, "One finger down swipe", "/proc/touchpanel/down_swipe_enable"}},
    {7, {63, "One finger left swipe", "/proc/touchpanel/left_swipe_enable"}},
